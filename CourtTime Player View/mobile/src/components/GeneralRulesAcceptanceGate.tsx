/**
 * General Rules acceptance gate
 * Renders when the authenticated player has pending General Rules versions to accept.
 * Blocks the rest of the app until each pending facility's rules are accepted.
 */
...
export function GeneralRulesAcceptanceGate() {
  const { pendingGeneralRulesAcceptances, acceptGeneralRulesAndContinue, logout } = useAuth();
  ...
  const handleAccept = async () => {
    ...
    if (ok) {
      ...
      showAlert('Error', 'Could not accept General Rules. Please try again.');
    }
    setSubmitting(false);
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>General Rules Update</Text>
        <Text style={styles.subtitle}>
          You must accept the latest General Rules for{' '}
