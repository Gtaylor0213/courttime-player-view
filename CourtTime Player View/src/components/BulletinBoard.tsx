...
import { formatCentsAsUsd } from '../../shared/utils/money';
...
export function BulletinBoard() {
  ...
  const [createDefaultFacilityId, setCreateDefaultFacilityId] = useState('');
  ...
  const openCreateModal = () => {
    ...
    setCreateDefaultFacilityId(defaultFacility);
  ...
  return (
    <>
      ...
      <BulletinPostCreateModal
        ...
        defaultFacilityId={createDefaultFacilityId}
      />
