              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-medium">New booking created</div>
                      <div className="text-xs text-gray-600">Court 3 - 2:00 PM today</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2" />
                    <div>
                      <div className="text-sm font-medium">Member registered</div>
                      <div className="text-xs text-gray-600">Sarah Johnson joined</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">Court 1 - Tomorrow 9:00 AM</div>
                    </div>
                  </div>
                </div>
              </CardContent>
