...
export function FacilityRulesTab(props: Props) {
  const {
    currentFacilityId,
    isEditing, setIsEditing, saving, facilityData,
    handleSave, handleCancel,
    renderSectionSaveFooter, renderTabFooterSaveBar,
    handleBookingRulesChange, addPeakHourSlot, removePeakHourSlot,
    updatePeakHourSlotTime, updatePeakHourSlotRule,
